...
2. [Install Serbian (Latin) Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Serbian (Latin) language pack](#3-how-to-active-hungarian-language-pack)
