...
![Serbian (Latin) language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-serbian-latin-language-pack:dev-master mageplaza/module-smtp 
