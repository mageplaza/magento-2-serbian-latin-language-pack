# How to contribute Serbian (Latin) Language pack
...
- This file [crowdin_pull.csv](https://github.com/mageplaza/magento-2-serbian-latin-language-pack/blob/master/crowdin_pull.csv) has been pulled from [Crowdin](https://crowdin.com/project/magento-2) daily, so you should not change/edit the file.

- [github_contributions.csv](https://github.com/mageplaza/magento-2-serbian-latin-language-pack/blob/master/github_contributions.csv) has been contributed by Mageplaza community.

- We will merge two files: crowdin_pull.csv and github_contributions.csv into [sr_Cyrl_RS.csv](https://github.com/mageplaza/magento-2-serbian-latin-language-pack/blob/master/sr_Cyrl_RS.csv). Your Magento 2 store will use this csv file.
